...
class WorldModel():
        ...
        for sensor in FRONT,SIDE:
            for side in L,R:
                ...
                for object in objects:
                    dist,x,y,k1,k2,c = object.intersects(x1,y1,x2,y2)
                    if (dist >= 0):
                        if dist < mindist:
                            mindist = dist
                            minx = x
                ...
                minx,miny = min_object.add_noise(x1,y1,x2,y2,mindist,mink1,mink2,minc)
    ...
    def sample_us(self):
        ...
        for object in objects:
            dist,x,y,k1,k2,c = object.intersects(x1,y1,x3,y3)
            if (dist >= 0):
                if dist < mindist:
                    mindist = dist
                    minx = x
    ...
    def check_collision(self):
        ...
        for object in objects:
            for bumper in [0,1,2,3]:
                ...
                dist,x,y,k1,k2,c = object.intersects(xt1,yt1,xt2,yt2)
                if (dist == -2): 
