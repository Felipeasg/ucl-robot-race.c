...
class WallModel(BaseObj):
    ...
    def intersects(self, x1,y1,x2,y2):
        ...
        return tuple([i_dist, i_x, i_y, k1, k2, c])

    def add_noise(self, x1, y1, x2, y2, noisy_dist, k1, k2, c):
        if k1 == 0 and c == 0:
            if k2 == 0:
